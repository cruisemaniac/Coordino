	...
	<div class="<?=($answer['Answer']['status'] == 'correct') ? 'answered' : 'answer';?>" id="a_<?=$answer['Answer']['public_key']?>">
		...
		<div class="post_actions wrapper">
			<div class="user_info wrapper">
				<div style="float: left;">
				<div class="thumb_with_border">
					<?php echo $html->image($gravatar->urlFromhash($answer['User']['image'], array('size' => 25, 'default' => 'mm')), array('width' => 25, 'height' => 25, 'alt' => $answer['User']['username'], 'url' => '/users/' .$answer['User']['public_key'].'/'.$answer['User']['username'], 'escape' => false));
					?>				
				</div>
				<div style="float: left; line-height: .9;">
					<div>
