 ...
 */
	...
	/**
	* Generate Image URL based on HASH stored in Database
	* @param string HASH value from User.image
	* @return string Gravatar Image URL
	*/
	
	public function urlFromHash($hash, $options = array())
	{
		...
		$imageUrl = $this->__url[$protocol] . $hash;
		if($ext === true)
		{
			$imageUrl .= '.jpg';
		}
